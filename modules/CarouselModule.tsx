    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="bg-orange-50 border-l-4 border-orange-500 p-5 mb-8 rounded-r-2xl shadow-sm animate-fadeIn">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            Tạo bộ ảnh cuộn (Carousel) TikTok chuyên nghiệp với kịch bản dẫn dắt tâm lý, kể chuyện cá nhân hoặc tổng hợp kiến thức. Hình ảnh được tối ưu hóa cho định dạng 3:4 với chữ nghệ thuật đi kèm, giúp tăng tương tác. Có thể chọn vị trí chữ xuất hiên trên Top - Bottom hoặc Center (giữa), màu sắc chữ, kich cỡ chữ.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <select 
                  ...
                  className="w-full p-3.5 bg-white border border-slate-200 rounded-[10px] text-sm font-medium outline-none focus:border-orange-500 transition-all shadow-sm"
                >
            ...
            <div className="space-y-1.5">
              ...
              <textarea 
                ...
                className="w-full h-32 p-4 border border-slate-200 rounded-[10px] text-sm font-medium focus:border-orange-500 outline-none transition-all resize-none bg-slate-50 focus:bg-white"
              />
            </div>
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold text-slate-500 uppercase tracking-widest px-1 text-orange-600">5. Mô tả nhân vật:</label>
              <textarea 
                ...
                className="w-full h-24 p-3.5 border border-slate-200 rounded-[10px] text-sm font-medium focus:border-orange-500 outline-none transition-all bg-slate-50 focus:bg-white resize-none"
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 gap-4">
               <div className="space-y-1.5">
                  ...
                  <select 
                    ...
                    className="w-full p-3.5 bg-white border border-slate-200 rounded-[10px] text-sm font-bold outline-none focus:border-orange-500 shadow-sm"
                  >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  className="w-full p-3.5 border border-slate-200 rounded-[10px] text-sm font-medium focus:border-orange-500 outline-none transition-all bg-slate-50 focus:bg-white"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4">
               <div className="space-y-2">
                ...
                <select 
                  ...
                  className="w-full p-3.5 bg-white border border-slate-200 rounded-[10px] text-sm font-bold outline-none focus:border-orange-500 transition-all shadow-sm focus:ring-1 focus:ring-orange-200"
          ...
          <div className="lg:col-span-2 pt-4">
            <button 
              ...
              className="w-full py-5 bg-slate-900 text-white font-black rounded-[10px] text-base shadow-xl hover:bg-black transition-all disabled:opacity-50 uppercase tracking-widest active:scale-[0.98]"
            >
      ...
      <div className="flex flex-col items-center gap-8 py-12 border-t border-slate-200">
          <button 
              ...
              className="px-12 py-5 bg-orange-600 text-white font-black rounded-2xl shadow-2xl hover:scale-105 active:scale-95 transition-all text-lg flex items-center gap-4 uppercase tracking-widest"
          >
