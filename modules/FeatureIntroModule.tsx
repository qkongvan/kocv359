...
const FeatureIntroModule: React.FC = () => {
  const features = [
    ...
    {
      id: 'nonface2',
      title: 'Review Giày Dép',
      description: 'Module chuyên biệt được thiết kế riêng cho ngành hàng thời trang giày dép. Hệ thống AI hiểu rõ các đặc tính quan trọng như form dáng, chất liệu da, độ êm ái của đế và các chi tiết gia công tinh xảo. Với các góc quay bám sát bước chân và bối cảnh sử dụng thực tế (đi bộ, chạy, phối đồ), module này giúp phô diễn trọn vẹn vẻ đẹp và công năng của từng đôi giày, đáp ứng những yêu cầu khắt khe nhất của khách hàng. Bạn cũng có thể ứng dụng module này để review những sản phẩm như quần hay váy vóc…',
      icon: <Footprints className="w-6 h-6" />,
      color: 'bg-emerald-500',
    },
    {
      id: 'videopov',
      title: 'StoryTelling (POV)',
      description: 'Tạo ra trải nghiệm nhập vai tuyệt vời cho khách hàng thông qua góc nhìn thứ nhất (Point of View). Module này giúp người xem cảm thấy như chính họ đang trực tiếp trải nghiệm sản phẩm, từ việc mở hộp, chạm vào bề mặt đến việc sử dụng thực tế trong đời sống. Góc nhìn POV tạo ra sự kết nối cá nhân mạnh mẽ, giúp xóa bỏ rào cản giữa người bán và người mua, từ đó tăng tỷ lệ tin tưởng và quyết định mua hàng nhanh chóng.',
