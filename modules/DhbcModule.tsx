        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm text-orange-900 leading-relaxed">
              Sáng tạo các nội dung "Đuổi hình bắt chữ" hóm hỉnh và trí tuệ với sự trợ giúp của AI. Công cụ tự động tạo ra các hình ảnh ẩn dụ logic, giúp bạn nhanh chóng xây dựng các video trò chơi tương tác cao, thu hút lượng lớn bình luận và lượt xem từ khán giả.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-4 space-y-6">
          ...
          <button 
            ...
            className="w-full py-4 bg-orange-600 hover:bg-orange-700 text-white font-black rounded-xl shadow-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2 uppercase tracking-widest text-sm"
          >
        ...
        <div className="lg:col-span-8 flex flex-col items-center pt-[10px]">
          ...
          <div className="mt-8 flex gap-4 w-full max-w-sm">
            ...
            <button 
              ...
              className="flex-1 py-4 bg-orange-600 hover:bg-orange-700 text-white font-black rounded-2xl flex items-center justify-center gap-2 transition-all disabled:opacity-30 uppercase text-xs tracking-widest shadow-lg"
            >
              Prompt
            </button>
          </div>
