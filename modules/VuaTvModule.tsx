        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm text-orange-900 leading-relaxed">
              Sáng tạo các thử thách "Vua Tiếng Việt" độc đáo và hóm hỉnh với sự hỗ trợ của AI. Công cụ tự động phân tích đáp án để tạo ra các hình ảnh minh họa ẩn dụ logic, giúp bạn nhanh chóng xây dựng các video trò chơi ngôn ngữ hấp dẫn, thu hút tương tác và bình luận từ cộng đồng.
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    ...
                    <input 
                      ...
                      className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-100 focus:border-orange-500 outline-none font-bold text-xs"
                    />
                  </div>
                  <div className="w-20">
                    ...
                    <input 
                      ...
                      className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-100 outline-none font-bold text-xs"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {SUGGESTED_PUZZLES.map((s, i) => (
                    <button 
                      ...
                      className="px-3 py-1.5 bg-slate-100 hover:bg-orange-50 hover:text-orange-600 rounded-lg text-[10px] font-bold transition-all border border-transparent hover:border-orange-200"
                    >
                      {s.a}
                    </button>
                  ))}
            ...
            <div className="space-y-4">
              <div>
                ...
                <div 
                  ...
                  className="w-full h-24 border-2 border-dashed border-slate-200 rounded-xl flex items-center justify-center bg-slate-50 cursor-pointer hover:border-orange-400 transition-all overflow-hidden"
                >
                  {state.facePreview ? (
                ...
                <input 
                  ...
                  className="w-full mt-2 p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:ring-1 focus:ring-orange-500 outline-none"
                />
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:ring-1 focus:ring-orange-500 outline-none h-32 resize-none font-medium"
                />
              </div>
            </div>
            <button 
              ...
              className="w-full mt-6 py-4 bg-orange-600 hover:bg-orange-700 text-white font-black rounded-2xl shadow-lg shadow-orange-100 transition-all disabled:opacity-50 flex items-center justify-center gap-2 uppercase tracking-widest text-sm"
            >
        ...
        <div className="lg:col-span-8 flex flex-col items-center">
          ...
          <div className="mt-8 flex gap-4 w-full max-w-sm">
            <button 
              ...
              className="flex-1 py-4 bg-slate-900 hover:bg-black text-white font-black rounded-2xl flex items-center justify-center gap-2 transition-all disabled:opacity-30 uppercase text-xs tracking-widest shadow-xl"
            >
              Tải ảnh
            </button>
            <button 
              ...
              className="flex-1 py-4 bg-orange-600 hover:bg-orange-700 text-white font-black rounded-2xl flex items-center justify-center gap-2 transition-all disabled:opacity-30 uppercase text-xs tracking-widest shadow-xl"
            >
              Prompt
            </button>
          </div>
          ...
          {state.isVideoPromptVisible && (
            <div className="mt-8 w-full max-w-2xl bg-slate-900 rounded-3xl p-6 border border-slate-800 animate-slideUp">
              <div className="flex justify-between items-center mb-4">
                <span className="text-[10px] font-black text-orange-500 uppercase tracking-widest">Kịch bản Video VEO-3</span>
                <button 
